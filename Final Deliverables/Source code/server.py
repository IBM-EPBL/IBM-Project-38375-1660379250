...
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=fbd88901-ebdb-4a4f-a32e-9822b9fb237b.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;PORT=32731;SECURITY=SSL;SSLServerCertificate=credientials/DigiCertGlobalRootCA.crt;UID=kpd38366;PWD=k1rvymX5jAsKVp7X",'','')
print(conn)
         ...
         if request.method == "POST":
              ...
              if userPassword == userConfirmPassword:
                     ...
                     if account:
                            ...
                            try:
                                   sg = SendGridAPIClient('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')
